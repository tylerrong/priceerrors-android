...
class AppOptionsTest {
    ...
    fun `unknown persisted keys safely fall back to defaults`() {
        ...
        assertEquals(FeedLayoutOption.SCROLL, FeedLayoutOption.fromKey(""))
    }
    ...
    fun `known persisted keys restore exact choices`() {
        ...
        assertEquals(FeedLayoutOption.SCROLL, FeedLayoutOption.fromKey("grid"))
        assertEquals(FeedLayoutOption.SCROLL, FeedLayoutOption.fromKey("scroll"))
    }
}
